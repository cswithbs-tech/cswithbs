...
export const Button = ({ 
  ...
  const baseStyles = "inline-flex items-center justify-center font-medium transition-all focus:outline-none cursor-pointer disabled:opacity-50 disabled:cursor-default disabled:pointer-events-none rounded-lg relative overflow-hidden";
