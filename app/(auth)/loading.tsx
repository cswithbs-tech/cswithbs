    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050505]">
       <div className="flex flex-col items-center gap-6">
          <div className="relative h-16 w-16">
               ...
               <div className="relative h-16 w-16 bg-gradient-to-tr from-accent to-purple-600 rounded-full flex items-center justify-center shadow-lg shadow-accent/20">
          ...
          <p className="text-zinc-500 font-medium tracking-wide text-xs uppercase">Authenticating...</p>
       </div>
    </div>
  );
}
