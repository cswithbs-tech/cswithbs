...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (urlError === 'RegistrationClosed') {
    ...
    >
        ...
        <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#000000] px-2 text-zinc-500">Or continue with</span>
            </div>
        </div>
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <Button variant="primary" className="w-full mt-2" size="lg" isLoading={loading}>
                {loading ? 'Verifying...': 'Sign In'}
            </Button>
            
            <p className="text-center text-sm text-zinc-500 mt-4">
                Don't have an account?{' '}
                <Link href="/signup" className="font-medium text-white hover:text-accent transition-colors">
                    Sign up
                </Link>
            </p>
        </form>
